...
export PODS_NET=192.168.0.0/16

export NODEPORT_RANGE=80-32767
...
export CONTROLLER_PUBLIC_IPS=( 54.152.200.2 54.165.226.66 54.86.199.171 )
export CONTROLLER_PRIVATE_IPS=( 172.31.50.165 172.31.61.157 172.31.50.102 )

export WORKER_PUBLIC_IPS=( 54.208.34.112 )
export WORKER_PRIVATE_IPS=( 172.31.49.217 )

export KUBE_APISERVER_SERVICE_IP=10.200.0.1
export KUBE_DNS_SERVICE_IP=10.200.0.33

export CLUSTER_DOMAIN=hacluster.local
...
## regular user
export USER_NAME=daniel_dominguez
